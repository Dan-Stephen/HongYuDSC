...
if ($_REQUEST['act'] == 'advanced_search') {
	...
	if ($search_type == 0) {
		...
		while ($row = $db->FetchRow($res)) {
			...
			$price_info = get_goods_one_attr_price($row, $region_id, $area_id, $promote_price);
