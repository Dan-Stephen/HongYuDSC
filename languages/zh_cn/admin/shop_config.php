...
$_LANG['cfg_range']['sms_type'][3] = '模版堂';
...
$_LANG['cfg_name']['dsc_appkey'] = '模版堂(appKey)';
$_LANG['cfg_name']['dsc_appsecret'] = '模版堂(appSecret)';
...
$_LANG['cfg_name']['wholesale_user_rank'] = '是否支持普通会员购买商品和发布求购单';
...
$_LANG['cfg_desc']['order_delay_num'] = '单订单可申请延迟收货次数';
