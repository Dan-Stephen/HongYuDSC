...
if (!empty($check['tips']) && count($check['tips']) > 0) {
    $check['tips'][] = "<a href=\"http://www.fuwuweb.com/article/88\" target=\"_blank\">鸿宇大商创安装教程</a> <a href=\"http://www.fuwuweb.com\" target=\"_blank\">鸿宇社区</a> <a href=\"http://bbs.hongyuvip.com\" target=\"_blank\">鸿宇论坛</a>";
}
