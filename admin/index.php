...
if ($_REQUEST['act'] == '') {
	...
	if (strpos($http, 'https://') === false) {
		$Loaction = 'http://www.hongyuvip.com/cloud/index.html';
	}
	else {
		$Loaction = 'https://www.hongyuvip.com/cloud/index.html';
	}
	...
	if (strpos($http, 'https://') === false) {
		$Loaction = 'http://hongyuvip.com/cloud/platform_rec.html';
	}
	else {
		$Loaction = 'https://hongyuvip.com/cloud/platform_rec.html';
	}
	...
	if (strpos($http, 'https://') === false) {
		$Loaction = 'http://hongyuvip.com/cloud/best_rec.html';
	}
	else {
		$Loaction = 'https://hongyuvip.com/cloud/best_rec.html';
	}
