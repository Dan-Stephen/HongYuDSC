...
if ($_REQUEST['act'] == '') {
	...
	$sql = 'SELECT COUNT(*) FROM ' . $ecs->table('store_order') . ' as o, ' . $GLOBALS['ecs']->table('order_info') . ' AS oi1 ' . ' WHERE (o.store_id = \'' . $_SESSION['stores_id'] . '\' OR (o.store_id = \'0\' AND o.is_grab_order = \'1\' ))' . $where . ' AND oi1.order_id = o.order_id';
