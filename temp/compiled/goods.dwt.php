...
?>
                                        ...
                                        <div class="bt-info-tips">
                                            ...
                                            <div class="tips">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <p>2､什么是白条分期？<br>白条分期是商城推出的一种“先消费，后付款”的全新支付方式。使用白条进行付款，可以享受最长30天的延后付款期或最长24期的分期付款方式。</p>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="choose-btns<?php if (! $this->_var['area_position_list'] || $this->_var['goods']['store_count'] <= 0 || ! $this->_var['stages'] || $this->_var['goods']['is_on_sale'] == 0): ?> ml60<?php endif; ?> clearfix">
                                <?php if ($this->_var['shop_close'] == 0 && $this->_var['goods']['user_id'] != 0): ?>
                                	<a class="btn-invalid" href="javascript:void(0);">此店铺已关闭</a>
                                <?php else: ?>
                                    <?php if ($this->_var['goods']['is_alone_sale'] == 0): ?>
                                    <a href="category.php?id=347" class="btn-buynow">查看类似商品</a>
                                    <?php else: ?>
                ...
                <div class="seller-pop">
                    ...
                    <div class="seller-info">
                        ...
                        <?php if ($this->_var['shop_information']['is_IM'] == 1 || $this->_var['shop_information']['is_dsc']): ?>
                            <a id="IM" href="javascript:;" onclick="openWin(this)" ru_id="<?php echo $this->_var['goods']['user_id']; ?>"><i class="icon i-kefu"></i></a>
                        <?php else: ?>
                    ...
                    <div class="seller-tel"><i class="iconfont icon-tel"></i><?php if ($this->_var['shop_information']['kf_tel']): ?><?php echo $this->_var['shop_information']['kf_tel']; ?><?php else: ?>暂无联系方式<?php endif; ?></div>
                </div>
                <?php endif; ?>
                <div class="clear"></div>
            </div>
...
?>
                                ...
                                <dl class="goods-para">
                                    <?php $_from = $this->_var['extend_info']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'info_0_30128300_1517022098');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['info_0_30128300_1517022098']):
?>	
                                    <dd class="column"><span title="<?php echo htmlspecialchars($this->_var['info_0_30128300_1517022098']); ?>"><?php echo $this->_var['key']; ?>：<?php echo htmlspecialchars($this->_var['info_0_30128300_1517022098']); ?></span></dd>
                                    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                                </dl>
                                <?php endif; ?>
                                <?php if ($this->_var['properties']): ?>
                            ...
                            <div class="gm-warp">
                                <div class="praise-rate-warp">
                                    ...
                                    <div class="actor-new">
                                        ...
                                        <dl>
                                            <dd ectype="comment_tag" data-type="1"><span class="red">全部</span></dd>
