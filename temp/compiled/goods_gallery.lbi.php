...
?>
    ...
    <div class="short-share">
        ...
        <div class="left-btn">
            ...
            <a href="javascript:void(0);" class="collection choose-btn-coll" data-dialog="goods_collect_dialog" data-divid="goods_collect" data-url="user.php?act=collect" data-goodsid="<?php echo $this->_var['goods']['goods_id']; ?>"><i class="iconfont choose-btn-icon<?php if ($this->_var['goods']['is_collect']): ?> icon-collection-alt<?php else: ?> icon-collection<?php endif; ?>" id="collection_iconfont"></i><em>收藏 (<span id="collect_count"></span>)</em></a>
