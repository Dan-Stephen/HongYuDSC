...
?>
        ...
        <div class="lift lift-mode-<?php echo empty($this->_var['floor_nav_type']) ? 'one' : $this->_var['floor_nav_type']; ?> lift-hide" ectype="lift" data-type="<?php echo empty($this->_var['floor_nav_type']) ? 'one' : $this->_var['floor_nav_type']; ?>" style="z-index:100001">
            <div class="lift-list" ectype="liftList">
                ...
                <?php $_from = $this->_var['floor_data']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'data_0_58863900_1517022909');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['data_0_58863900_1517022909']):
?>
                <div class="lift-item lift-floor-item" ectype="liftItem"><span><?php echo $this->_var['data_0_58863900_1517022909']['name']; ?></span><i class="lift-arrow"></i></div>
