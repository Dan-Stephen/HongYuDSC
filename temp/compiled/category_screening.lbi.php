                    ...
                    <div class="s-l-value brand_select_more">
                        <div class="all_a_z">
                            <ul class="a_z">
                                ...
                                <?php $_from = $this->_var['letter']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'letter_0_59081800_1516982599');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['letter_0_59081800_1516982599']):
?>
                                <li data-key="<?php echo $this->_var['letter_0_59081800_1516982599']; ?>"><?php echo $this->_var['letter_0_59081800_1516982599']; ?></li>
                                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                        ...
                        <div class="wrap_brand">  
                            <div class="brand_div">
                                <?php $_from = $this->_var['brands']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'brand_0_59090300_1516982599');if (count($_from)):
    foreach ($_from AS $this->_var['brand_0_59090300_1516982599']):
?>
                                <div class="brand_img_word" brand ="<?php echo $this->_var['brand_0_59090300_1516982599']['brand_letters']; ?>">
                                    <?php if ($this->_var['brand_0_59090300_1516982599']['brand_logo']): ?>
                                        <a href="<?php echo $this->_var['brand_0_59090300_1516982599']['url']; ?>">
                                        	<img src="<?php echo $this->_var['brand_0_59090300_1516982599']['brand_logo']; ?>" alt="<?php echo $this->_var['brand_0_59090300_1516982599']['brand_name']; ?>" title="<?php echo $this->_var['brand_0_59090300_1516982599']['brand_name']; ?>"> 
                                        	<span><?php echo $this->_var['brand_0_59090300_1516982599']['brand_name']; ?></span>
                                        </a>
                                    <?php else: ?>
                                        <a href="<?php echo $this->_var['brand_0_59090300_1516982599']['url']; ?>"><b><?php echo $this->_var['brand_0_59090300_1516982599']['brand_name']; ?></b></a> 
                                    <?php endif; ?>
                                </div>
                                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                            </div>
                        ...
                        <div class="zimu_list">
                            <ul class="get_more" >
                                <?php $_from = $this->_var['brands']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'brand_0_59107100_1516982599');if (count($_from)):
    foreach ($_from AS $this->_var['brand_0_59107100_1516982599']):
?>
                                <li class="is_no" brand ="<?php echo $this->_var['brand_0_59107100_1516982599']['brand_letters']; ?>" url_id="<?php echo $this->_var['brand_0_59107100_1516982599']['brand_id']; ?>"><span class="choose_ico"></span><a class="goods_brand_name" data-url="<?php echo $this->_var['brand_0_59107100_1516982599']['url']; ?>"><?php echo $this->_var['brand_0_59107100_1516982599']['brand_name']; ?></a></li>
                                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                            </ul>
                        </div>
...
?>
            <li class="s-line same_li">
            	<dl class="s-l-wrap attr_list">
                    <div class="s-l-tit filter_attr_name"><?php echo htmlspecialchars($this->_var['filter_attr']['filter_attr_name']); ?>：</div>
                    <div class="s-l-value attr_son">
                        <div class="item_list">
