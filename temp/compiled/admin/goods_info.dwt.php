                            ...
                            <div class="sort_tit">
                                ...
                                <div class="select_list select_w320" id="sortcommList">
                                    ...
                                    <ul>
                                        ...
                                        <?php $_from = $this->_var['recently_used_category']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'category_0_66243700_1517723231');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['category_0_66243700_1517723231']):
?>
                                        <li><a href="javascript:void(0);" data-value="<?php echo $this->_var['key']; ?>"><?php echo $this->_var['category_0_66243700_1517723231']; ?></a></li>
...
?>
                                    ...
                                    <div class="item">
                                         <div class="step_label">虚拟销量：</div>
                                         <div class="step_value"><input type="text" name="sales_volume_base" class="text w150" autocomplete="off" value="<?php echo $this->_var['goods']['sales_volume_base']; ?>"/></div>
                                    </div>
                                    <div class="item">
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="step_value">
                                            <div class="selection">
                                                ...
                                                <a href="javascript:void(0);" class="btn btn30 blue_btn" ectype="ajaxBrand">添加</a>
                                                ...
                                                <div class="brand-top">
                                                    <div class="letter">
                                                        <ul>
                                                            ...
                                                            <?php $_from = $this->_var['letter']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'letter_0_66292900_1517723231');if (count($_from)):
    foreach ($_from AS $this->_var['letter_0_66292900_1517723231']):
?>
                                                            <li><a href="javascript:void(0);" data-letter="<?php echo $this->_var['letter_0_66292900_1517723231']; ?>"><?php echo $this->_var['letter_0_66292900_1517723231']; ?></a></li>
                                                            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                                    ...
                                    <div class="item item_wenzi">
                                        ...
                                        <div class="step_value">
											...
											<div class="notic ml70"><?php echo $this->_var['lang']['lab_goods_img_notic']; ?></div>
...
?>
                                            ...
                                            <a href="javascript:;" class="btn btn30 blue_btn fl mr5" ectype="ajaxTransport">添加</a>
                                            <a href="javascript:;" class="btn btn30 blue_btn fl" data-attr="edit" ectype="ajaxTransport">编辑</a>
                                            </div>
										</div>
                                    </div>	
                                    <div class="item">
...
?>
                                                        <div class="checkbox_item">
                                                            <input type="radio" name="region" class="ui-radio" id="warehouse_region_<?php echo $this->_var['area']['region_id']; ?>" <?php if (($this->_foreach['area']['iteration'] <= 1) && ($this->_foreach['warehouse']['iteration'] <= 1)): ?>checked<?php endif; ?> value="<?php echo $this->_var['area']['region_id']; ?>" data-type="region_id"/>
                            ...
                            <div class="step w190" ectype="filter" data-filter="article">
                                ...
                                <div class="step_content" style="display:none">
                                    <div class="goods_search_div">
                                        ...
                                        <a href="javascript:void(0);" class="btn btn30 red_btn" ectype="ajaxArticle">添加新文章</a>
                                    </div>
                                    <div class="move_div">
                                        <div class="move_left">
...
?>
                                        ...
                                        <a href="javascript:void(0);" class="btn btn30 mr10" ectype="search"><i class="icon icon-search"></i><?php echo $this->_var['lang']['search_word']; ?></a>
                                        <a href="javascript:void(0);" class="btn btn30 red_btn" ectype="ajaxArea">添加新地区</a>
                                    </div>
                                    <div class="move_div">
                                        <div class="move_left">
	...
	*/
	...
	$(document).on("click","[ectype='ajaxArticle']",function(){
        $.jqueryAjax('dialog.php', 'act=ajaxArticle', function(data){
            goods_visual_desc("添加文章",1000,data.content,function(){
