...
?>
            ...
            <th width="8%" <?php if ($this->_var['goods_attr_price'] == 0 || $this->_var['add_shop_price'] == 1): ?>class="hide"<?php endif; ?>><em class="require-field">*</em>市场价<i class="sc_icon sc_icon_edit pointer pro_market"></i></th>
            ...
            <th width="8%" <?php if ($this->_var['goods_attr_price'] == 0 || $this->_var['add_shop_price'] == 1): ?>class="hide"<?php endif; ?>><em class="require-field">*</em>促销价<i class="sc_icon sc_icon_edit pointer pro_promote"></i></th>
            <th width="10%"><em class="require-field">*</em>库存<i class="sc_icon sc_icon_edit pointer pro_number"></i></th>
            <th width="10%"><em class="require-field">*</em>预警值<i class="sc_icon sc_icon_edit pointer pro_warning"></i></th>
            <th width="12%">商品货号</th>
