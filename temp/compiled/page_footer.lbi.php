    ...
    <div class="footer-new-bot">
    	<div class="w w1200">
            ...
            <p class="copyright_links">
                <?php $_from = $this->_var['navigator_list']['bottom']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'nav_0_62130100_1516982599');$this->_foreach['nav_bottom_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['nav_bottom_list']['total'] > 0):
    foreach ($_from AS $this->_var['nav_0_62130100_1516982599']):
        $this->_foreach['nav_bottom_list']['iteration']++;
?>
                <a href="<?php echo $this->_var['nav_0_62130100_1516982599']['url']; ?>"<?php if ($this->_var['nav_0_62130100_1516982599']['opennew'] == 1): ?> target="_blank" <?php endif; ?>><?php echo $this->_var['nav_0_62130100_1516982599']['name']; ?></a>
...
?>
            ...
            <p><span>©&nbsp;2015-2019&nbsp;www.hongyuvip.com&nbsp;版权所有&nbsp;&nbsp;</span><span><?php echo $this->_var['lang']['icp_number']; ?>:</span><a href="http://www.miibeian.gov.cn/" target="_blank"><?php echo $this->_var['icp_number']; ?></a>&nbsp;Powered By&nbsp;<a href="http://www.hongyuvip.com/" target="_blank">鸿宇大商创</a></p>
            <?php endif; ?>
...
?>
    ...
    <div class="hidden">
        <input type="hidden" name="seller_kf_IM" value="<?php echo $this->_var['shop_information']['is_IM']; ?>" rev="<?php echo $this->_var['site_domain']; ?>" ru_id="<?php echo empty($_GET['merchant_id']) ? '0' : $_GET['merchant_id']; ?>" />
