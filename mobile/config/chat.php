...
return [
    'root_path' => 'https://demo.hongyuvip.com/',  //  项目根目录，用于找到mobile/touchim模块  需写全http 或https  例localhost/dsc/（必填）
    'listen_route' => 'demo.hongyuvip.com',   // 监听地址 （必填， 本机域名）   例: www.ectouch.cn  不用http 或 https
