...
class IndexController extends \App\Modules\Base\Controllers\FrontendController
{
	...
	public function actionIndex()
	{
		...
		$share_desc = !empty($pages['description']) ? $pages['description'] : C('shop.shop_desc');
		...
		$share_data = array('title' => $position['title'], 'desc' => $share_desc, 'link' => '', 'img' => $share_img);
		$this->assign('share_data', $this->get_wechat_share_content($share_data));
		$this->assign('page_title', $position['title']);
		$this->assign('description', $share_desc);
